...
with tab1:
    ...
    # Calcular múltiples niveles como la diferencia entre la suma individual y el total real
    suma_individual = iniciales + primarias + secundarias
    multiples = suma_individual - total
    ...
    col5.metric("Múltiples niveles", multiples if multiples > 0 else 0)
